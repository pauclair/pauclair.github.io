...
rm -rf _site
#remove your cache 
rm file__0.localstorage http_localhost_4000.localstorage 
...
#change legend.html
#generate file by starting ./create_period_schedule.py This creates both planning.html and schedule.html
